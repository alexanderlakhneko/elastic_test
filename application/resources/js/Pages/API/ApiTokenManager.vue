        ...
        <jet-form-section @submitted="createApiToken">
            ...
            <template #form>
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <jet-input autofocus class="mt-1 block w-full" id="name" type="text"
                ...
                <div class="col-span-6" v-if="availablePermissions.length > 0">
                    ...
                    <div class="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div :key="permission" v-for="permission in availablePermissions">
                            <label class="flex items-center">
                                <input :value="permission" class="form-checkbox" type="checkbox"
        ...
        <div v-if="tokens.length > 0">
            ...
            <div class="mt-10 sm:mt-0">
                <jet-action-section>
                    ...
                    <template #content>
                        <div class="space-y-6">
                            <div :key="token.id" class="flex items-center justify-between" v-for="token in tokens">
                                <div>
                                    {{ token.name }}
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <button @click="manageApiTokenPermissions(token)"
                                            class="cursor-pointer ml-6 text-sm text-gray-400 underline focus:outline-none"
                                            v-if="availablePermissions.length > 0">
                                        Permissions
                                    </button>

                                    <button @click="confirmApiTokenDeletion(token)"
        ...
        <jet-dialog-modal :show="managingPermissionsFor" @close="managingPermissionsFor = null">
            ...
            <template #footer>
                ...
                <jet-button :class="{ 'opacity-25': updateApiTokenForm.processing }"
                            :disabled="updateApiTokenForm.processing" @click.native="updateApiToken" class="ml-2">
                    Save
                </jet-button>
            </template>
        </jet-dialog-modal>
        ...
        <jet-confirmation-modal :show="apiTokenBeingDeleted" @close="apiTokenBeingDeleted = null">
            ...
            <template #footer>
                ...
                <jet-danger-button :class="{ 'opacity-25': deleteApiTokenForm.processing }"
                                   :disabled="deleteApiTokenForm.processing" @click.native="deleteApiToken"
                                   class="ml-2">
                    Delete
                </jet-danger-button>
            </template>
