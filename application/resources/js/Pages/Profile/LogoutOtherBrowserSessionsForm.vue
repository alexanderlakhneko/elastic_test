    ...
    <jet-action-section>
        ...
        <template #content>
            ...
            <div class="mt-5 space-y-6" v-if="sessions.length > 0">
                <div :key="i" class="flex items-center" v-for="(session, i) in sessions">
                    <div>
                        <svg class="w-8 h-8 text-gray-500" fill="none" stroke="currentColor" stroke-linecap="round"
                             stroke-linejoin="round" stroke-width="2" v-if="session.agent.is_desktop"
                             viewBox="0 0 24 24">
                            <path
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="confirmingLogout = false">
                ...
                <template #content>
                    ...
                    <div class="mt-4">
                        <jet-input @keyup.enter.native="logoutOtherBrowserSessions" class="mt-1 block w-3/4"
                ...
                <template #footer>
                    ...
                    <jet-button :class="{ 'opacity-25': form.processing }" :disabled="form.processing"
                                @click.native="logoutOtherBrowserSessions" class="ml-2">
                        Logout Other Browser Sessions
                    </jet-button>
                </template>
            </jet-dialog-modal>
