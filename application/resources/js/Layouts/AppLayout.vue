            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    ...
                    <div class="mt-3 space-y-1">
                        ...
                        <jet-responsive-nav-link :active="route().current('api-tokens.index')"
                        ...
                        <template v-if="$page.jetstream.hasTeamFeatures">
                            ...
                            <template v-for="team in $page.user.all_teams">
                                <form :key="team.id" @submit.prevent="switchToTeam(team)">
                                    <jet-responsive-nav-link as="button">
                                        <div class="flex items-center">
                                            <svg class="mr-2 h-5 w-5 text-green-400" fill="none" stroke="currentColor"
                                                 stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                 v-if="team.id == $page.user.current_team_id" viewBox="0 0 24 24">
